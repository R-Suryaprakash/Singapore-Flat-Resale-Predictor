...
st.markdown("<h1 style='text-align: center; color: red;'>Singapore Flat Resale Price Predicton</h1>",unsafe_allow_html=True)

df=pd.read_csv(r"C:/Users/surya/OneDrive/Desktop/suryavs/final.csv")
...
with tab3:
    ...
    if st.button(':blue[Predict and Conclusion]'):
            
            def load_data():
                # Load data
                data = pd.read_csv(r"C:/Users/surya/OneDrive/Desktop/suryavs/final.csv")
            ...
            st.markdown('### :blue[Some Insights...]')
            st.write('* Resale price of the flats are majorly depends on the number of :red[storeys in the flat, Flat type, Floor area].')
            ...
            st.write('* Proximity to amenities such as :red[MRT stations, schools, shopping malls, parks], and other facilities can significantly impact resale prices.')
